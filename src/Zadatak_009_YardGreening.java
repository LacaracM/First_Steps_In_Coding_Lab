...
public class Zadatak_009_YardGreening {

    //9.	Yard Greening
    //Sophia has several houses on the Black Sea coast and wants to green the yards of some of them,
    // thus creating a cozy atmosphere and comfort for its guests. She has hired a company for this purpose.
    ...
    public static void main(String[] args) {
        ...
        double kvadrati;
        kvadrati = Double.parseDouble(scanner.nextLine());
        double Price = kvadrati * 7.61;
        double discount = Price * 0.18;
        double finalPrice = Price - discount;
        System.out.printf("The final price is: %.2f USD.\nThe discount is: %.2f USD. ",
                finalPrice, discount);
